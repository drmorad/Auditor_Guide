...
export const TeamIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.226A3 3 0 0113.12 12.51a3 3 0 012.27 2.277M6.879 16.863A3 3 0 017.12 14.51a3 3 0 012.27 2.277M8.118 15.54A9.043 9.043 0 0112 15.011m-3.882.529A9.058 9.058 0 0112 15.012a9.058 9.058 0 013.882.528M15 7.5a3 3 0 11-6 0 3 3 0 016 0zm6 3a9 9 0 11-18 0 9 9 0 0118 0z" />
  </svg>
);

export const AuditLogIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h.01M15 12h.01M10.5 16.5h3m-6.38-3.386a3.375 3.375 0 014.257 4.257 3.375 3.375 0 01-4.257-4.257zM12 21a9 9 0 100-18 9 9 0 000 18z" />
    </svg>
);
...
export const ClipboardCheckIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 8.25V6a2.25 2.25 0 00-2.25-2.25H9.75A2.25 2.25 0 007.5 6v2.25m9 0v2.25a2.25 2.25 0 01-2.25 2.25H9.75a2.25 2.25 0 01-2.25-2.25V8.25m9 0H7.5" />
    </svg>
);
...
export const SettingsIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-1.007 1.11-.952l2.176.422c.599.116 1.03.623 1.03 1.22l-.01 2.392a1.75 1.75 0 01-1.636 1.742l-2.22.324c-.65.095-1.222-.44-1.222-1.099V3.94zm0 8.256a1.75 1.75 0 01-1.636-1.742V8.892c0-.67.57-1.196 1.222-1.099l2.22.324c.614.09.994.622.994 1.226l-.01 2.392c-.01.67-.57 1.196-1.222 1.099l-2.22-.324zM13.832 17.02a1.75 1.75 0 01-1.636 1.742l-2.22.324c-.65.095-1.222-.44-1.222-1.099V14.54c0-.67.57-1.196 1.222-1.099l2.22.324c.614.09.994.622.994 1.226l-.01 2.392z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.75a1.75 1.75 0 100-3.5 1.75 1.75 0 000 3.5zM12 13.25a1.75 1.75 0 100-3.5 1.75 1.75 0 000 3.5zM12 19.75a1.75 1.75 0 100-3.5 1.75 1.75 0 000 3.5z" />
    </svg>
);
