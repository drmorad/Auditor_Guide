...
export const TeamIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.752 3.752 0 015.968 0m-11.522 2.962a3.753 3.753 0 015.968 0M6 18.75a9.094 9.094 0 013.741-.479 3 3 0 01-4.682-2.72M12 12.75a3.75 3.75 0 110-7.5 3.75 3.75 0 010 7.5z" />
  </svg>
);
...
export const ChatBubbleIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.537a59.731 59.731 0 01-1.04 1.04l-1.255 1.255a2.25 2.25 0 01-3.182 0l-1.255-1.255a59.731 59.731 0 01-1.04-1.04l-3.722-.537A2.25 2.25 0 012.25 15v-4.286c0-.97.616-1.813 1.5-2.097v6.086A2.25 2.25 0 005.25 18h13.5a2.25 2.25 0 002.25-2.25v-6.086zM15 4.5a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);
...
export const ChatBubbleLeftRightIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.537a59.731 59.731 0 01-1.04 1.04l-1.255 1.255a2.25 2.25 0 01-3.182 0l-1.255-1.255a59.731 59.731 0 01-1.04-1.04l-3.722-.537A2.25 2.25 0 012.25 15v-4.286c0-.97.616-1.813 1.5-2.097v6.086A2.25 2.25 0 005.25 18h13.5a2.25 2.25 0 002.25-2.25v-6.086zM4.5 12.75a7.5 7.5 0 0115 0v2.25a7.5 7.5 0 01-15 0v-2.25z" />
    </svg>
);
...
export const CalendarCheckIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M9.75 14.25l1.5 1.5 3-3" />
    </svg>
);
